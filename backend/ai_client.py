...
def summarize_replay(rid: str) -> str:
    ...
    return generate_text(prompt, system_instruction="Summarize and provide remediation steps.")
...
def suggest_defense_for_event(event: dict) -> str:
    ...
    return generate_text(prompt, system_instruction="Provide a single concise defensive recommendation.")
